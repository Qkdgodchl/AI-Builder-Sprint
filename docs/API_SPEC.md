...
| 구현 | 성공 | 실패 | Method | Path | 권한 | 설명 |
|---|---|---|---|---|---|---|
| [ ] | [ ] | [ ] | POST | `/ai/consultations` | USER | 상담 세션 시작 |
| [ ] | [ ] | [ ] | POST | `/ai/consultations/{id}/messages` | 상담 소유자 | 메시지 전송·의향 구조화 |
| [ ] | [ ] | [ ] | GET | `/ai/consultations/{id}` | 상담 소유자 | 상담·구조화 결과 조회 |
| [ ] | [ ] | [ ] | PATCH | `/ai/consultations/{id}/intent` | 상담 소유자 | 구조화 값 직접 수정 |
| [ ] | [ ] | [ ] | POST | `/ai/consultations/{id}/confirm` | 상담 소유자 | 의향 최종 확인 |
